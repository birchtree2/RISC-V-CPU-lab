...
#
# Script generated by Vivado on Mon May 27 13:23:28 +0800 2024
...
# script info
echo -e "ROM.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L dist_mem_gen_v8_0_13 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ROM xil_defaultlib.ROM xil_defaultlib.glbl -log elaborate.log
}
