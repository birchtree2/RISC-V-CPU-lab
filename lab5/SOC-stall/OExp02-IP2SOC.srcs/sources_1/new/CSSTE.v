...
wire [0:0]BTN_OK0_Dout;
  ...
  wire tmp_cpu_mio;//no use,but need to be connected to avoid warning
  wire [31:0] U1_PC_out_EX, U1_PC_out_ID, U1_inst_ID,  U1_Data_out_WB, U1_MemRW_EX;
  Pipeline_CPU U1
       (
        ...
        .clk(clk),
        .inst_IF(U2_spo),
        .PC_out_EX(U1_PC_out_EX),//调试用
        .PC_out_ID(U1_PC_out_ID),//调试用
        .inst_ID(U1_inst_ID),//调试用
        .PC_out_IF(U1_PC_out),//跟之前的PC_out一样
        .Addr_out(U1_Addr_out),//跟之前的Addr_out一样
        .Data_out(U1_Data_out),//跟之前的Data_out一样
        .Data_out_WB(U1_Data_out_WB),//调试用
        .MemRW_Mem(U1_MemRW),//跟之前的MemRW一样
        .MemRW_EX(U1_MemRW_EX)//调试用
        );
  ...
  VGA U11
       (.clk_25m(div1_Dout),
        ...
        .PC_IF(U1_PC_out),
        .inst_IF(U2_spo),
        .PC_ID(U1_PC_out_ID),//不同阶段的PC和inst,用来debug
        .inst_ID(U1_inst_ID),
         .PC_Ex(U1_PC_out_EX),
