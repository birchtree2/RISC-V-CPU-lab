...
output reg [1:0] inttype//中断类型: 01:ill 10:ecall 11:mret
); 
reg [1:0]ALUop;
`define CPU_ctrl_signals {ALUSrc_B, MemtoReg, RegWrite, MemRW, Branch ,Jump,ALUop, ImmSel,inttype,BranchN}
...
parameter alui = 2'b11;
  always @*begin
      case(OPcode)
      5'b01100: begin `CPU_ctrl_signals={1'b0,2'b00,1'b1,1'b0,1'b0,2'b00,alu,3'b000,2'b00,1'b0}; end //ALU R
      5'b00000: begin `CPU_ctrl_signals={1'b1,2'b01,1'b1,1'b0,1'b0,2'b00,addr,3'b000,2'b00,1'b0}; end //load I
      5'b01000: begin `CPU_ctrl_signals={1'b1,2'b00,1'b0,1'b1,1'b0,2'b00,addr,3'b001,2'b00,1'b0}; end //store S
      5'b11000: begin //beq/bne SB
        case (Fun3) 
          3'b000: begin  //beq 
      ...
      5'b11011: begin `CPU_ctrl_signals={1'b0,2'b10,1'b1,1'b0,1'b0,2'b01,addr,3'b011,2'b00,1'b0}; end //jal UJ
      5'b00100: begin `CPU_ctrl_signals={1'b1,2'b00,1'b1,1'b0,1'b0,2'b00,alui,3'b000,2'b00,1'b0}; end //ALU+imm I
      5'b11001: begin `CPU_ctrl_signals={1'b1,2'b10,1'b1,1'b0,1'b0,2'b10,addr,3'b000,2'b00,1'b0}; end //jalr I
      // MemtoReg=10(因为要写入PC+4) RegWrite=1  JUMP=1  ALUSrc_B=1,因为PC=reg+imm
      5'b01101: begin `CPU_ctrl_signals={1'b0,2'b11,1'b1,1'b0,1'b0,2'b00,addr,3'b100,2'b00,1'b0}; end //lui U
